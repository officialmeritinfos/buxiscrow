                    ...
                    <div class="table-responsive">
                        @isset($referrals)
                            <div class="text-center">
                                <a href="{{url('merchant/referrals/earnings')}}" class="btn btn-outline-success" style="margin-bottom: 5px;">
                        ...
                        @else
                            <div class="text-center">
                                <a href="{{url('merchant/referrals')}}" class="btn btn-outline-primary" style="margin-bottom: 5px;">
