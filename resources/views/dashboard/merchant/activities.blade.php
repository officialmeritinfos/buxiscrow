                    ...
                    <div class="table-responsive">
                        @isset($logins)
                            <div class="text-center">
                                <a href="{{url('merchant/activities')}}" class="btn btn-outline-primary text-center" style="margin-bottom: 5px;">
                        ...
                        @else
                            <div class="text-center">
                                <a href="{{url('merchant/logins')}}" class="btn btn-outline-secondary text-center" style="margin-bottom: 5px;">
