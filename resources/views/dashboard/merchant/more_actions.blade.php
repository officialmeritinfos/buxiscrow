...
<div class="card" id="tabs-style3">
    ...
    <div class="card-body">
        <div class="btn-list text-center">
            <a href="{{url('merchant/documents/verify')}}" class="btn btn-dark"><i class="mdi mdi-account-check mr-2"></i> Verify Account</a>
        <!--<a href="{{url('merchant/documents/documents')}}" class="btn btn-primary"><i class="mdi mdi-file-document mr-2"></i> View Submitted Documents</a>
            @if($user->isVerified ==3)
            <a href="{{url('merchant/documents/error')}}" class="btn btn-dark"><i class="mdi mdi-account-check mr-2"></i> View Documents with Error</a>
            @endif-->
        </div>
    </div>
</div>
