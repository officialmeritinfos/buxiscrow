...
<div class="row">
    <div class="col-xl-4 col-lg-5">
        <div class="card box-widget widget-user">
            ...
            <div class="card-body text-center">
                <div class="pro-user">
                    ...
                    <form method="post" action="{{url('merchant/settings/profile_change')}}" id="update_profile_pic"
                    ...
                    @if($user->isVerified ==2)
                        <p class="text-danger" style="font-size:15px;">Your account is unverified.
                            Verify Now to enjoy premium and unlimited features.<a href="{{url('merchant/documents/verify')}}">
                                Start Now
                            </a>
                        </p>
                    @endif
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{url('merchant/settings/change_password')}}" id="change_password">
    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{url('merchant/settings/update_profile')}}"
                      id="updateProfile">
                    @csrf
