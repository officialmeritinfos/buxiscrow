            ...
            <div class="card-body">
                <div class="">
                    <div class="text-center">
                        ...
                        data-target="#add_faq">Add Business Category</button>
                    </div>
                            ...
                            <table id="example" class="table table-bordered text-nowrap key-buttons">
                                ...
                                @foreach($categories as $type)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('admin/business_category/edit/'.$type->id)}}" class="btn btn-outline-info">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="{{url('admin/business_category/delete/'.$type->id)}}" class="btn btn-outline-danger">
    ...
    <div class="modal-dialog modal-dialog-centered text-center " role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h1 class="modal-title">Add Business Category</h1>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body text-left p-4" >
                <form method="POST" action="{{url('admin/business_category/add')}}">
                    @csrf
                    <div class="row">
