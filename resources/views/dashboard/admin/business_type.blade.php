            ...
            <div class="card-body">
                <div class="">
                    <div class="text-center">
                        ...
                        data-target="#add_faq">Add Business Type</button>
                    </div>
                    <div class="table-responsive">
                        @isset($business_types)
                            <table id="example" class="table table-bordered text-nowrap key-buttons">
                                <thead>
                                <tr>
                                    <th class="border-bottom-0">Name</th>
                                    <th class="border-bottom-0">Is Crypto</th>
                                ...
                                @foreach($business_types as $type)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('admin/business_type/edit/'.$type->id)}}" class="btn btn-outline-info">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="{{url('admin/business_type/delete/'.$type->id)}}" class="btn btn-outline-danger">
    ...
    <div class="modal-dialog modal-dialog-centered text-center " role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h1 class="modal-title">Add Business Type</h1>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body text-left p-4" >
                <form method="POST" action="{{url('admin/business_type/add')}}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 text-center">
                            <div class="form-group">
                                <label class="form-label">Is Crypto <span class="text-red">*</span></label>
                                <select class="form-control form-control-lg" name="isCrypto">
