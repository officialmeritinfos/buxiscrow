                ...
                <div class="pro-user">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <h4 class="pro-user-username text-dark mb-1">Merchant</h4>
                            <p>
                                {{$merchant->name}} ({{$merchant->email}})
                            </p>
                            <h4 class="pro-user-username text-dark mb-1">Business</h4>
                            <p>
                                {{$business->name}} ({{$business->businessRef}})
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-body text-center">
                    <div class="pro-user">
                        <div class="alert alert-primary">
                            ...
                            <hr class="message-inner-separator">
                            <p>
                                No delivery service/partner is being used.
                            </p>
                            <br>
                        </div>
                    </div>
