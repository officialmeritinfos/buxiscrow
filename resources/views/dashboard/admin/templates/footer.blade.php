        ...
        <div class="modal-dialog modal-dialog-centered text-center " role="document">
            <div class="modal-content tx-size-sm">
                ...
                <div class="modal-body text-left p-4" >
                    <form method="POST" id="set_trans_pin" action="{{url('admin/dashboard/set_pin')}}">
                        @csrf
                        <div >
...
<script src="{{ asset('dashboard/admin/dashboard.js')}}"></script>
<script src="{{ asset('dashboard/admin/business.js')}}"></script>
<script src="{{ asset('dashboard/admin/escrows.js')}}"></script>
<script src="{{ asset('dashboard/admin/transfer.js')}}"></script>
<script src="{{ asset('dashboard/admin/profile.js')}}"></script>
<script src="{{ asset('dashboard/admin/verification.js')}}"></script>
<script src="{{ asset('dashboard/admin/payment_link.js')}}"></script>
