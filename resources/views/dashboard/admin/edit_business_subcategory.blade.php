...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{url('admin/business_subcategory/edit')}}">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6 col-md-6 text-center">
                            <div class="form-group">
                                ...
                                name="name" value="{{$category->subcategory_name}}">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6 text-center">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-lg" name="category">
                                    ...
                                    <option value="{{$category->category_id}}" selected>{{$option->getBusinessCategory($category->category_id)}}</option>
