            ...
            <div class="card-body">
                <div class="">
                    <div class="text-center">
                        ...
                        data-target="#add_faq">Add Faq</button>
                    </div>
                            ...
                            <table id="example" class="table table-bordered text-nowrap key-buttons">
                                ...
                                @inject('option','App\Custom\CustomChecks')
                                    <tr>
                                        <td>{{$faq->question}}</td>
                                        <td>{{$faq->answer}}</td>
                                        <td>{{$option->getFaqCategory($faq->category_id)}}</td>
                                        <td>{{$faq->created_at}}</td>
                                        <td>
                                            <a href="{{url('admin/faqs/edit/'.$faq->id)}}" class="btn btn-outline-info">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="{{url('admin/faqs/delete/'.$faq->id)}}" class="btn btn-outline-danger">
    ...
    <div class="modal-dialog modal-dialog-centered text-center " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-left p-4" >
                <form method="POST" action="{{url('admin/faqs/add')}}">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12 col-md-12 text-center">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg " placeholder="Title"
                                       name="question" id="amount">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 text-center">
                            <div class="form-group">
                                <label class="form-label">Answer <span class="text-red">*</span></label>
                                <textarea class="form-control form-control-lg" id="exampleInputPassword1" name="answer"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 text-center">
                            <div class="form-group">
