                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <small class="mb-1 text-muted">
                                                <button class="btn btn-outline-info btn-sm" data-backdrop="static" data-keyboard="false"
                                                        data-toggle="modal" data-target="#withdraw_ref">Withdraw</button>
                                            </small>
                                        </div>
                                    </div>
                             </div>
									...
									<div class="col-xl-4 col-lg-4 col-md-6">
										<div class="card">
											<div class="card-body">
												...
												<p class=" mb-1"></p>
												<h2 class="mb-1 font-weight-bold">Pay Merchant</h2>
                                                <small class="mb-1 text-muted"><span class="text-info">Pay a Merchant</span></small>
											</div>
										</div>
									</div>
									<div class="col-xl-4 col-lg-4 col-md-6">
										<div class="card" data-backdrop="static" data-keyboard="false"  data-toggle="modal" data-target="#new_transfer">
											<div class="card-body">
                                                ...
                                                <small class="mb-1 text-muted"><span class="text-info">Send money to friends</span></small>
											</div>
										</div>
									</div>
                                    <div class="col-xl-4 col-lg-4 col-md-6">
...
@include('dashboard.user.templates.dashboard_modal')
@include('dashboard.user.templates.transfer_modal')
