                                ...
                                @switch($transaction->transactionType)
                                    ...
                                    @case(2)
                                        <p class="text-muted text-center">This is just a preview of the main transaction.
                                            Find details <a href="{{url('account/transfers/'.$transaction->transactionRef.'/details')}}"
                                            class="text-primary">here</a></p>
                                    @break
                                    @case(3)
                                    <p class="text-muted text-center">This is just a preview of the main transaction.
                                        Find details <a href="{{url('account/escrows/'.$transaction->transactionRef.'/details')}}"
                                                        class="text-primary">here</a></p>
                                    @break
                                    @case(4)
                                    <p class="text-muted text-center">This is just a preview of the main transaction.
                                        Find details <a href="{{url('account/bills/'.$transaction->transactionRef.'/details')}}"
                                                        class="text-primary">here</a></p>
                                    @break
                                @endswitch
                            </div>
