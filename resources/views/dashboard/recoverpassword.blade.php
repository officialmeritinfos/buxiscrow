                                ...
                                <div class="card p-4">
                                    <div class="card-body">
                                        <div class="text-center title-style mb-6">
                                            <h1 class="mb-2">{{$pageName}}</h1>
                                            <hr>
                                        </div>
                                        <form method="post" class="needs-validation was-validated"
                                              id="recover_account" action="{{url('api/reset-password')}}">
                                            @csrf
                                            <div class="form-group">
                                                <label class="form-label">Email</label>
                                                <div class="input-group">
                                                    <input type="email" class="form-control form-control-lg is-valid state-valid"
                                                           placeholder="Email" name="email" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 text-center">
                                                    <button type="submit" class="btn btn-md btn-gradient-primary btn-info " id="submit"
