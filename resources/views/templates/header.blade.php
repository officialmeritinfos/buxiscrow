                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item">
                                    <a href="{{url('about')}}" class="nav-link">Blog Details</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item">
                                    <a href="#" class="nav-link">Stores <small class="badge badge-success">coming soon</small></a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item">
                                    <a href="{{url('payment-link')}}" class="nav-link">Plugins </a>
                                </li>
                            </ul>
                        </li>
